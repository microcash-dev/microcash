...
usage () {
	echo "USAGE: build-microcash.sh [-v version] [-s SIGNER] [-d true/false]"
...
# Clone sources
git clone git://github.com/MicroCashTeam/fair-coin.git microcash
...
bin/gbuild ../microcash/contrib/gitian-descriptors/boost-linux.yml
mv build/out/boost-*.zip inputs/

bin/gbuild ../microcash/contrib/gitian-descriptors/deps-linux.yml
mv build/out/microcash-deps-*.zip inputs/

bin/gbuild ../microcash/contrib/gitian-descriptors/qt-linux.yml
mv build/out/qt-*.tar.gz inputs/

bin/gbuild ../microcash/contrib/gitian-descriptors/boost-win.yml
mv build/out/boost-*.zip inputs/

bin/gbuild ../microcash/contrib/gitian-descriptors/deps-win.yml
mv build/out/microcash-deps-*.zip inputs/

bin/gbuild ../microcash/contrib/gitian-descriptors/qt-win.yml
mv build/out/qt-*.zip inputs/

bin/gbuild ../microcash/contrib/gitian-descriptors/protobuf-win.yml
...
cd ..
git clone https://github.com/MicroCashTeam/gitian.sigs.git
