/* src/config/microcash-config.h.  Generated from microcash-config.h.in by configure.  */
/* src/config/microcash-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef MICROCASH_CONFIG_H

#define MICROCASH_CONFIG_H
...
#define PACKAGE_BUGREPORT "support@fair-coin.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MicroCash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MicroCash Core 1.1.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "microcash"

/* Define to the home page for this package. */
#define PACKAGE_URL "http://fair-coin.org/"
