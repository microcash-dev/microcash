...
pkgdatadir = $(datadir)/microcash
pkgincludedir = $(includedir)/microcash
pkglibdir = $(libdir)/microcash
pkglibexecdir = $(libexecdir)/microcash
...
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	...
	$(top_srcdir)/src/config/microcash-config.h.in \
	...
	README src/build-aux/compile src/build-aux/config.guess \
...
CONFIG_HEADER = $(top_builddir)/src/config/microcash-config.h
...
ACLOCAL = ${SHELL} /home/pool.finalhash.com/fair-coin/src/build-aux/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/pool.finalhash.com/fair-coin/src/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/pool.finalhash.com/fair-coin/src/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/pool.finalhash.com/fair-coin/src/build-aux/missing automake-1.14
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx
...
CFLAGS = -g -O2 -Wall -Wextra -Wformat -Wformat-security -Wno-unused-parameter -DHAVE_BUILD_INFO  -Wstack-protector -fstack-protector-all -fPIE
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /home/pool.finalhash.com/fair-coin/src/build-aux/missing makeinfo
MAKENSIS = 
MKDIR_P = /bin/mkdir -p
MOC = 
...
OTOOL = 
PACKAGE = microcash
PACKAGE_BUGREPORT = support@fair-coin.org
PACKAGE_NAME = MicroCash Core
PACKAGE_STRING = MicroCash Core 1.1.1
PACKAGE_TARNAME = microcash
PACKAGE_URL = http://fair-coin.org/
...
abs_builddir = /home/pool.finalhash.com/fair-coin
abs_srcdir = /home/pool.finalhash.com/fair-coin
abs_top_builddir = /home/pool.finalhash.com/fair-coin
abs_top_srcdir = /home/pool.finalhash.com/fair-coin
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_OBJC = gcc
ac_ct_OBJCXX = g++
...
install_sh = ${SHELL} /home/pool.finalhash.com/fair-coin/src/build-aux/install-sh
...
SUBDIRS = src
GZIP_ENV = "-9n"
BITCOIND_BIN = $(top_builddir)/src/MicroCashd$(EXEEXT)
BITCOIN_QT_BIN = $(top_builddir)/src/qt/MicroCash-qt$(EXEEXT)
BITCOIN_WIN_INSTALLER = $(PACKAGE)-$(PACKAGE_VERSION)-win$(WINDOWS_BITS)-setup$(EXEEXT)
OSX_APP = MicroCash-Qt.app
OSX_DMG = MicroCash-Qt.dmg
OSX_DEPLOY_SCRIPT = $(top_srcdir)/contrib/macdeploy/macdeployqtplus
OSX_FANCY_PLIST = $(top_srcdir)/contrib/macdeploy/fancy.plist
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/microcash.icns
OSX_PLIST = $(top_srcdir)/share/qt/Info.plist #not installed
OSX_QT_TRANSLATIONS = da,de,es,hu,ru,uk,zh_CN,zh_TW
DIST_DOCS = $(wildcard doc/*.md) $(wildcard doc/release-notes/*.md)
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/microcash.ico \
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/microcash.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/MicroCash-Qt
...
src/config/microcash-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/microcash-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/microcash-config.h
$(top_srcdir)/src/config/microcash-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/microcash-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/Resources/microcash.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/MicroCash-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(OSX_DMG): $(OSX_APP_BUILT) $(OSX_PACKAGING)
	...
	$(GENISOIMAGE) -no-cache-inodes -l -probe -V "MicroCash-Qt" -no-pad -r -apple -o $@ dist
...
#	$(LCOV) -c -d $(abs_builddir)/src --t MicroCashJBlockTest -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb
